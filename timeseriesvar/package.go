...
func GetEntry[T GetEntryConstraints](h http.Header, uri string) (t T, status runtime.Status) {
	...
	defer access.LogDeferred(access.InternalTraffic, access.NewRequest(h, http.MethodGet, uri), "", "", -1, "", &status)()
...
func PostEntry[T PostEntryConstraints](h http.Header, method, uri string, body T) (t any, status runtime.Status) {
	...
	defer access.LogDeferred(access.InternalTraffic, access.NewRequest(h, method, uri), "", "", -1, "", &status)()
...
func HttpHandler(w http.ResponseWriter, r *http.Request) {
	...
	func() (status runtime.Status) {
		defer access.LogDeferred(access.InternalTraffic, r, "", "", -1, "", &status)()
